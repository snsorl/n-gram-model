...
def add_k_smoothing(bigram_counts, unigram_counts, vocab_size, k=0.01):
...
def compute_perplexity(test_data, unigram_probs, bigram_probs, smoothing_probs):
    ...
    for sentence in test_data:
        for i in range(1, len(sentence)):
            ...
            prob = smoothing_probs.get((w1, w2), 1e-6)  # Small probability if unseen
...
perplexity_laplace = compute_perplexity(processed_valid, unigram_probs, bigram_probs, laplace_probs)
perplexity_add_k = compute_perplexity(processed_valid, unigram_probs, bigram_probs, add_k_probs)

# Print Final Results
print("\n=========== RESULTS ===========")
print(f"Perplexity (Laplace Smoothing): {perplexity_laplace:.2f}")
print(f"Perplexity (Add-k Smoothing): {perplexity_add_k:.2f}")
print("================================")
